...
async function authWithApple() {
    ...
    try {
        ...
        if (code === 'auth/operation-not-allowed') {
            setStatus('Login Apple indispon�vel neste projeto no momento. Use Google, Email/Senha ou Visitante.');
            setGateStatus('Login Apple indispon�vel neste projeto no momento. Use Google, Email/Senha ou Visitante.');
            return;
        }
